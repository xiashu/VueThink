...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-06-16 08:50:50
...
(53, 52, '系统配置', '', 'el-icon-document', 1, 0, 1, 61, 'Administrative', ''),
...
(57, 52, '组织架构', '', 'el-icon-date', 1, 0, 1, 63, 'Administrative', ''),
...
(61, 52, '账户管理', '', 'el-icon-setting', 1, 0, 1, 62, 'Administrative', ''),
...
--
-- AUTO_INCREMENT for table `oa_admin_group`
--
ALTER TABLE `oa_admin_group`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `oa_admin_menu`
--
ALTER TABLE `oa_admin_menu`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '菜单ID', AUTO_INCREMENT=63;
--
-- AUTO_INCREMENT for table `oa_admin_post`
--
ALTER TABLE `oa_admin_post`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
-- AUTO_INCREMENT for table `oa_admin_rule`
--
ALTER TABLE `oa_admin_rule`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
--
-- AUTO_INCREMENT for table `oa_admin_structure`
--
ALTER TABLE `oa_admin_structure`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
--
-- AUTO_INCREMENT for table `oa_admin_user`
--
ALTER TABLE `oa_admin_user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `oa_system_config`
--
ALTER TABLE `oa_system_config`
